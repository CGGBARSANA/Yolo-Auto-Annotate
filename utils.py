...
def save_yolo_format(
    ...
    Parameters:
        ...
        directory (str): Base directory to save the label file.
        ...
        class_selection_mode: Mode for custom label manager.
...
def save_current_annotation(image_path, detections, selected_boxes, box_labels, original_shape, directory, file_name, class_selection_mode="both", sub_folder=""):
    ...
    try:
        ...
        annotation_file = os.path.join(directory, sub_folder, f"{file_name}_annotation.json")
