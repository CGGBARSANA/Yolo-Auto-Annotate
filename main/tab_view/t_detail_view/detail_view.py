...
from .annotate_label import AnnotateLabel
...
class DetailView(QWidget):
    def __init__(self, parent_annotator=None):
        ...
        self.worker = None
        self.annotate_qlabel = AnnotateLabel()
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        # Custom manage_label_btn management buttons
        ...
        self.annotate_qlabel.setAlignment(Qt.AlignCenter)
        self.annotate_qlabel.setMinimumSize(800, 600)
        self.annotate_qlabel.setStyleSheet("border: 1px solid gray;")

        right_layout = QVBoxLayout()
        right_layout.addWidget(self.annotate_qlabel)
